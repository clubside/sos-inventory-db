/// <reference path="../types/sos-objects.js" />

/**
 * @typedef {Object} SOSObjectField
 * @property {String} name - name of the field
 * @property {("string"|"integer"|"boolean"|"decimal"|"object"|"array"|"reference"|"timestamp")} type - datatype of the field
 * @property {String} [objectType] - definition of the object
 */
/**
 * @typedef {Object} SOSObject
 * @property {String} [description] - description of the object
 * @property {SOSObjectField[]} fields - fileds of the object
 */
const sosObjects = {
	address: {
		fields: [
